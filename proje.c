...
with st.sidebar:
    ...
    st.markdown("1. Emir Ayaz - 230206038")
    st.markdown("2. Oğuz Kaan Gülhan - 230206064")
    st.markdown("3. Emre Kumbar - 230206012")
    st.markdown("4. Zeynep Berrak Erdem - 230206058")
    st.markdown("5. Nisa Neziroğlu - 230206026")
    st.markdown("6. İdil Uğrak - 230206018")
    st.markdown("7. Ömer Kağan Metin - 230206054")
    st.markdown("8. Kerem Şentürk - 230206082")
    st.divider()
